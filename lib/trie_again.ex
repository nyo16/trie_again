defmodule TrieAgain do
  ...
  ## Example
      ...
      iex> trie = TrieAgain.new()
      iex> TrieAgain.insert(trie, "cat", "feline")
      :ok
      iex> TrieAgain.insert(trie, "car", "vehicle")
      :ok
      iex> TrieAgain.insert(trie, "card", "payment")
      :ok
      iex> TrieAgain.get(trie, "cat")
      {:ok, "feline"}
      iex> {:ok, results} = TrieAgain.auto_complete(trie, "ca", 10)
      iex> Enum.sort(results)
      ["car", "card", "cat"]
  """

  alias TrieAgain.Native
  ...
  ## Examples
      ...
      iex> trie = TrieAgain.new()
      iex> TrieAgain.insert(trie, "hello", "world")
      :ok
  """
  ...
  ## Examples
      ...
      iex> TrieAgain.insert(trie, "hello", "world")
      :ok
      iex> TrieAgain.get(trie, "hello")
      {:ok, "world"}
      iex> TrieAgain.get(trie, "missing")
      {:not_found, nil}
  """
  ...
  ## Examples
      ...
      iex> TrieAgain.insert(trie, "hello", "world")
      :ok
      iex> TrieAgain.delete(trie, "hello")
      :ok
      iex> TrieAgain.get(trie, "hello")
      {:not_found, nil}
  """
  ...
  ## Examples
      ...
      iex> TrieAgain.insert(trie, "cat", "feline")
      :ok
      iex> TrieAgain.prefix_search(trie, "ca")
      {:ok, true}
      iex> TrieAgain.prefix_search(trie, "dog")
      {:ok, false}
  """
  ...
  ## Examples
      ...
      iex> trie = TrieAgain.new()
      iex> TrieAgain.insert(trie, "cat", "1")
      :ok
      iex> TrieAgain.insert(trie, "car", "2")
      :ok
      iex> TrieAgain.insert(trie, "card", "3")
      :ok
      iex> {:ok, results} = TrieAgain.auto_complete(trie, "ca", 2)
  ...
  ## Examples
      ...
      iex> trie = TrieAgain.new()
      iex> TrieAgain.add_word_list(trie, ["cat", "car", "card"])
      :ok
      iex> TrieAgain.get(trie, "cat")
      {:ok, "cat"}
  """
  ...
  ## Examples
      ...
      iex> trie = TrieAgain.new()
      iex> TrieAgain.add_word_list(trie, ["cat", "car", "card", "dog"])
      :ok
      iex> TrieAgain.count_prefix(trie, "ca")
      {:ok, 3}
      iex> TrieAgain.count_prefix(trie, "do")
      {:ok, 1}
  """
